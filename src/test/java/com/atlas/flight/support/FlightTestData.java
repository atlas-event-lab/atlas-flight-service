...
public final class FlightTestData {
    ...
    public static CreateFlightRequest aCreateFlightRequest() {
        return new CreateFlightRequest(
                FLIGHT_NUMBER, AIRLINE_ID, ORIGIN_ID, DEST_ID,
                DEPARTURE, ARRIVAL, TOTAL_SEATS, aMoneyRequest(), List.of());
    }

    public static UpdateFlightRequest anUpdateFlightRequest(int totalSeats) {
        return new UpdateFlightRequest(
                FLIGHT_NUMBER, AIRLINE_ID, ORIGIN_ID, DEST_ID,
                DEPARTURE, ARRIVAL, totalSeats, aMoneyRequest(), List.of());
    }

    public static Flight aFlight() {
        return new Flight(
                FLIGHT_ID, FLIGHT_NUMBER, AIRLINE_ID, ORIGIN_ID, DEST_ID,
                DEPARTURE, ARRIVAL, TOTAL_SEATS,
                new Money(new BigDecimal("1200.00"), "USD"), FlightStatus.ACTIVE);
    }
